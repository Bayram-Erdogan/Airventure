...
def smugler_role(player):
    ...
    while True:
        if current == target:
            ...
            print('''                     ▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓
            ▓  you are geting into its                              ▓
            ▓   nice to work withe you, see you in another task             ▓
            ▓  But you can call me i wont answer anyway                         ▓ 
                                            ''')
        ...
        if current not in neighbors or not neighbors[current]:
            print(f"\nNo neighbor info for {current}. Can't continue.")
            update_leaderboard(player, money)
            show_leaderboard()
